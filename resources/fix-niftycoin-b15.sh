...
# pow targets
$SED -i "s,nPowTargetTimespan = 3.5 \* 24 \* 60 \* 60; // 3.5 days,nPowTargetTimespan = $POW_TARGET_TIMESPAN,g" src/chainparams.cpp
$SED -i "s,nPowTargetSpacing = 2.5 \* 60;,nPowTargetSpacing = $POW_TARGET_SPACING,g" src/chainparams.cpp

# defaultAssumeValid
$SED -i "s/0x59c9b9d3fec105bdc716d84caa7579503d5b05b73618d0bf2d5fa639f780a011/0x$MAIN_GENESIS_HASH/" src/chainparams.cpp
$SED -i "s/0xa0afbded94d4be233e191525dc2d467af5c7eab3143c852c3cd549831022aad6/0x$TEST_GENESIS_HASH/" src/chainparams.cpp
